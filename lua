...
if not isfile("neverSync") then
   makefolder("neverSync")
end
...
-- Menu/UI Creation
local menu = game:GetObjects("rbxassetid://71982222125279")[1] 
local tabholder = menu.bg.bg.bg.bg.bg.bg.main.group
local tabviewer = menu.bg.bg.bg.bg.bg.bg.tabbuttons

local library = {
   Title = 'never<font color="rgb(193, 154, 164)">Sync</font>',
   AnimatedText = false,
   keybind = Enum.KeyCode.End,
   Colors = {
      libColor = Color3.fromRGB(193, 154, 164),
      riskyColor = Color3.fromRGB(255, 0, 0),
      FontColor = Color3.fromRGB(255, 255, 255),
      MainColor = Color3.fromRGB(14, 14, 14),
      AccentColor = Color3.fromRGB(193, 154, 164),
...
task.spawn(function()
   local textList = { 
       '', 'e', 'ec', 'ecl', 'ecli', 'eclip', 'eclipse', 'eclipse.', 'eclipse.<font color="rgb(193, 154, 164)">w</font>',
       'eclipse.<font color="rgb(193, 154, 164)">wt</font>', 'eclipse.<font color="rgb(193, 154, 164)">wtf</font>',
       'eclipse.<font color="rgb(193, 154, 164)">wtf</font> |', 'eclipse.<font color="rgb(193, 154, 164)">wtf</font> | u',
       'eclipse.<font color="rgb(193, 154, 164)">wtf</font> | un', 'eclipse.<font color="rgb(193, 154, 164)">wtf</font> | uni',
       'eclipse.<font color="rgb(193, 154, 164)">wtf</font> | univ', 'eclipse.<font color="rgb(193, 154, 164)">wtf</font> | univers',
       'eclipse.<font color="rgb(193, 154, 164)">wtf</font> | universa', 'eclipse.<font color="rgb(193, 154, 164)">wtf</font> | universal',
       'eclipse.<font color="rgb(193, 154, 164)">wtf</font> | universa', 'eclipse.<font color="rgb(193, 154, 164)">wtf</font> | univers',
       'eclipse.<font color="rgb(193, 154, 164)">wtf</font> | univer', 'eclipse.<font color="rgb(193, 154, 164)">wtf</font> | unive',
       'eclipse.<font color="rgb(193, 154, 164)">wtf</font> | univ', 'eclipse.<font color="rgb(193, 154, 164)">wtf</font> | uni',
       'eclipse.<font color="rgb(193, 154, 164)">wtf</font> | un', 'eclipse.<font color="rgb(193, 154, 164)">wtf</font> | u',
       'eclipse.<font color="rgb(193, 154, 164)">wtf</font> |', 'eclipse.<font color="rgb(193, 154, 164)">wtf</font>',
       'eclipse.<font color="rgb(193, 154, 164)">wt</font>', 'eclipse.<font color="rgb(193, 154, 164)">w</font>',
   ...
   while wait(0.5) do
       if library.AnimatedText then
           ...
           menu.bg.pre.Text = 'never<font color="rgb(193, 154, 164)">Sync</font>'
       end
   end
end)  
      ...
      function library:GetTextBounds(Text, Font, Size, Resolution)
         ...
         function library:Create(Class, Properties)
            ...
            function library:Notify(Text, Time)
               ...
               local NotifyOuter = library:Create('Frame', {BorderColor3 = Color3.new(193, 154, 164);Position = UDim2.new(0, 100, 0, 10);Size = UDim2.new(0, 0, 0, YSize);ClipsDescendants = true;Transparency = 0,ZIndex = 100;Parent = library.NotificationArea});
               ...
               function draggable(a)local b=game:GetService("UserInputService")local c;local d;local e;local f;local g=0.25;local h=TweenInfo.new(g,Enum.EasingStyle.Quad,Enum.EasingDirection.Out)local function i(j)if not library.colorpicking then local k=j.Position-e;local l=UDim2.new(f.X.Scale,f.X.Offset+k.X,f.Y.Scale,f.Y.Offset+k.Y)local m=TweenService:Create(a,h,{Position=l})m:Play()end end;a.InputBegan:Connect(function(j)if j.UserInputType==Enum.UserInputType.MouseButton1 or j.UserInputType==Enum.UserInputType.Touch then c=true;e=j.Position;f=a.Position;j.Changed:Connect(function()if j.UserInputState==Enum.UserInputState.End then c=false end end)end end)a.InputChanged:Connect(function(j)if j.UserInputType==Enum.UserInputType.MouseMovement or j.UserInputType==Enum.UserInputType.Touch then d=j end end)b.InputChanged:Connect(function(j)if j==d and c then i(j)end end)end draggable(menu.bg)
                     ...
                     function library:Tween(...) TweenService:Create(...):Play() end
                        function library:addTab(name,image)
                           ...
                           for i,v in next, library.tabbuttons do
                              ...
                              local imageTweenStart = TweenService:Create(v, tweenInfo, {ImageColor3 = Color3.fromRGB(193, 154, 164)})
                              local textTweenStart = TweenService:Create(v.text, tweenInfo, {TextColor3 = Color3.fromRGB(193, 154, 164)})
                        ...
                        for _, v in pairs(list) do
                            ...
                            writefile("neverSync/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
                ...
                function library:refreshConfigs()
                    local tbl = {}
                    for i,v in next, listfiles("neverSync") do table.insert(tbl,v) end
